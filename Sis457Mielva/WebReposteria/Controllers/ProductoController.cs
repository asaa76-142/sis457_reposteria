...
namespace WebReposteria.Controllers
{
    ...
    {
        private readonly FinalReposteriaContext _context;

        public ProductoController(FinalReposteriaContext context)
        {
            _context = context;
        }
        ...
        {
            var finalReposteriaContext = _context.Productos.Include(p => p.IdUnidadMedidaNavigation);
            return View(await finalReposteriaContext.ToListAsync());
        }
